        ...
        <nav className="flex flex-col cursor-pointer pt-10 gap-3 md:gap-4 lg:pt-12 lg:gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <HoverWrapper>
              <li
                onClick={() => handleClick("https://github.com/Bachidze")}
                className="lg:hover:border-b lg:hover:border-white lg:w-[0%] text-[15px]  lg:whitespace-nowrap lg:hover:w-full  z-50 relative lg:hover:text-white lg:border-black lg:duration-700 md:text-[18px] lg:text-[20px] xl:text-[22px]"
              >
                Github
              </li>
            </HoverWrapper>
