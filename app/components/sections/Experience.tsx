  ...
  return (
    <section className="w-[90%] m-auto relative xl:-mb-14 xxl:-mb-20 3xl:-mb-36">
      <div className="group cursor-pointer relative">
        <HoverWrapper>
          <h2 className="md:text-[18px] lg:hover:border-white lg:hover:text-white z-50 lg:hover:border-b lg:w-0 lg:hover:w-[8%] lg:border-black lg:duration-700 text-[18px] lg:text-[20px] xl:text-[22px] absolute">
            EXPERIENCE
          </h2>
        </HoverWrapper>
      </div>
